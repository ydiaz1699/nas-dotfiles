...
1. Activar/cargar `.kiro/skills/datasql/SKILL.md` y leer `docs/services/aipostgres-guide.md` y la ficha de DataSQL.
...
|----------|------|--------------------------|
| **datasql** | `docs/services/aipostgres-guide.md` + `.kiro/skills/datasql/SKILL.md` | PostgreSQL+pgAdmin+Redis, procedimiento de roles/bases separado, Redis compartido, backups pg_dump, permisos, db_net |
