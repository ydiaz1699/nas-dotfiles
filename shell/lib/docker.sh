...
_SVC_GLOBAL_CMDS="lista health update-all menu port-map size net watch create doctor diff catalog-sync scan backup-all logs-grep clone cron doctor-history lock unlock --help -h"
