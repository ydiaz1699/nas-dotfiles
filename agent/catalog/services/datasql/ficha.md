...
La ficha apunta a `docs/services/datasql-guide.md`, la única guía del stack. Incluye instalación, migración histórica, operación, consumidores y creación de bases/roles.
